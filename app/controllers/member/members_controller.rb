class Member::MembersController < Member::BaseController 
  before_action :authenticate_user!
  before_action :set_member, only: %i[show edit update destroy redeem]
  ...
  def create
    ...
    if @member.save
      ...
      redirect_to member_member_path(@member), notice: "Member was successfully created."
    else
      load_services_and_coupons
  ...
  def update
    if @member.update(member_params)
      update_services_and_coupons
      redirect_to member_member_path(@member), notice: "Member was successfully updated."
    else
      load_services_and_coupons
  ...
  def redeem
    ...
    redirect_to member_members_path, notice: "Redeemed successfully!"
  end

  def destroy
    @member.destroy
    redirect_to member_members_path, notice: "Member was successfully deleted."
  end
